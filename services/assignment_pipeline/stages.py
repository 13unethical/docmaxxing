...
PIPELINE_STAGE_SPECS: tuple[StageSpec, ...] = (
    ...
    StageSpec(
        ...
        "Style Review",
        "Check tone, formatting, and academic writing quality.",
        StageProvider.INTERNAL,
        9,
    ),
    StageSpec(
        ...
        "Citation Generation",
        "Build reference list and in-text citations.",
    ...
    StageSpec(
        ...
        "Validate output against the Requirement JSON.",
        StageProvider.CHECK_PIPELINE,
        11,
    ),
    StageSpec(
        PipelineStage.REVISION,
        "Revision",
        "Fix gaps found during validation.",
        StageProvider.CLAUDE,
        12,
    ),
    StageSpec(
        ...
        "Humanization",
        "Refine voice to read naturally and academically.",
    ...
    StageSpec(
        ...
        "AI Detection",
        "Run similarity / AI detection checks before delivery.",
        StageProvider.TURNITIN,
        14,
    ),
    StageSpec(
